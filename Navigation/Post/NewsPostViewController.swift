...
//  Navigation
//
//  Created by Егор Ермолицкий on 15.03.2023.
//
...
class NewsPostViewController: UIViewController, UINavigationBarDelegate {
    ...
    lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = "\(postList[indexOfPostList].author)"
    ...
    lazy var newsImageView: UIImageView = {
        ...
        imageView.image = postList[indexOfPostList].image
    ...
    lazy var descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = postList[indexOfPostList].discription
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            newsImageView.heightAnchor.constraint(equalToConstant: size),
